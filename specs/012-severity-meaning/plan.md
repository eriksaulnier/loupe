...
**Scale/Scope**: Documentation only. One table and one line in `docs/comment-format.md`, one bullet in the workflow skill, one clause in a Go string literal, one pointer in spec 001 FR-007, and one row on the Unverified list.
